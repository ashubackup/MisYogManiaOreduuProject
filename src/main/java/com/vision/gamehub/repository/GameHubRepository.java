package com.vision.gamehub.repository;
...
import com.vision.gamehub.entity.TblSubscription;



@Repository
public interface GameHubRepository extends JpaRepository<TblSubscription, Integer>{
