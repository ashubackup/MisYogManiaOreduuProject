package com.vision.tselMoSmsVisiontrek.repository;
...
import com.vision.tselMoSmsVisiontrek.entity.TblSubscription;

@Repository
public interface TselMoSmsVisiontrekRepo extends JpaRepository<TblSubscription, Integer>{
