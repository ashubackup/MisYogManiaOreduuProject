...
import com.vision.tselMoSmsVisiontrek.repository.TselMoSmsVisiontrekRepo;
import com.vision.util.UtilityService;

@Service
public class TselMoSmsVisiontrekMisService {
	@Autowired
	private TselMoSmsVisiontrekRepo tselRepo;
	@Autowired
	private UtilityService service;
	
	public void tselMoSmsVisiontrekMisSave()
	{
		int date = 1;
		...
		MainServiceRequest mainService = service.setMainServiceRequest("Tsel", minusOneDay, 
